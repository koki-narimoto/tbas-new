...
import loveIllustrationImageSrc from "assets/treact-images/love-illustration.svg";
import { ReactComponent as StarIconBase } from "assets/treact-images/star-icon.svg";
import { ReactComponent as ArrowLeftIcon } from "assets/treact-images/arrow-left-3-icon.svg";
import { ReactComponent as ArrowRightIcon } from "assets/treact-images/arrow-right-3-icon.svg";

/* ======== importing some data for text =========== */
import { testimonials } from "assets/tbas-data/TbasInfo.jsx";
  ...
  return (
    <Container>
      <ContentWithPaddingXl>
        <Row>
          <ImageColumn>
            <Image src={loveIllustrationImageSrc} imageBorder={true} imageShadow={true} imageRounded={true} />
          </ImageColumn>
          <TextColumn textOnLeft={false}>
            <Subheading>{testimonials.subheading}</Subheading>
            <Heading>{testimonials.heading}</Heading>
            <Description>{testimonials.description}</Description>
